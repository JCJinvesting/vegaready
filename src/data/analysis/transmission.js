...
export const sectors = [
  {
    ...
    "icon": "01",
    "summary": "Refining margins, electricity generation, and fuel substitution sit one step downstream of crude and LNG. With ~20% of global LNG and 20% of crude transiting Hormuz, a chokepoint shock flows to pump prices in 1-3 weeks and to gas-indexed power within days. Impact is asymmetric: prices rocket up on shock, feather down on ceasefire.",
  ...
  },
  {
    ...
    "icon": "02",
    "summary": "The ~$600B global petrochemical chain runs on naphtha (crude-linked) and ethane (gas-linked). ~12.5% of global ethylene capacity sits in the Gulf conflict zone. A Hormuz closure removes cheap Gulf ethane and naphtha, spiking polymer prices 20-40% while US shale-ethane crackers see margins expand — a rare winner.",
    ...
    "mechanism": "Crude spike pulls naphtha up near-lockstep, so naphtha-based crackers (Asia/Europe) see feedstock costs jump and pass through to ethylene/propylene/polymers. Ethane stays near gas prices, so ethane crackers (US Gulf Coast, Gulf) see margins EXPAND as polymer prices rise while ethane stays flat. Gulf ethane is structurally cheap: Saudi $0.50-0.75/MMBtu vs $2.5-3.20/MMBtu in US/Europe.",
  ...
  },
  {
    ...
    "precedent": "1973 embargo: oil $2.90 to $11.65 (+300%, ~4 mo); US CPI >9%; GDP -0.5% (1974); Fed funds 5.75% to 12%. 2022 Russia-Ukraine: Brent $139.13 (7 Mar 2022); eurozone inflation 9% record. Red Sea 2024: war-risk 0.05% to 1.0% of hull; Suez traffic -50% (26,000 to 13,213 ships); Egypt canal revenue $10.25B (2023) to $3.99B (2024), -60%, ~$7B FX loss — a direct sovereign-FX cascade case study.",
  ...
  },
  {
    ...
    "icon": "09",
    "summary": "A double-exposure sector: ~99% of pharmaceutical feedstocks/reagents are petrochemical-derived, and the just-in-time generic supply chain runs through Gulf/Red Sea shipping lanes. The 2024 Red Sea diversion added ~2 weeks and doubled freight; the COVID analog saw pharma transport costs rise +224% on average (peak +413%). Concentrated API sourcing plus a freight shock equals multi-month shortages of thin-margin generics.",
    ...
    "mechanism": "Feedstock: ~99% of pharmaceutical feedstocks/reagents are petrochemical-derived (benzene, toluene, xylene to APIs); ~3% of petroleum output goes to pharma. An oil spike inflates inputs across nearly the whole synthesis chain plus plastics/packaging/devices. Shipping: Red Sea diversion around the Cape adds ~2 weeks / ~4,000 miles; shipping costs +100%, +~$200-400/TEU. Indian generic exporters to Europe (JIT model, little slack) are hit hardest (Moody's).",
