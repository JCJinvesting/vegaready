...
**Markup:** utility ticker · masthead · freshbar (with the Layman/Analyst toggle) · sticky `secnav` (with the Skim/Deep `.disc`) · `<section class="hero an-block" id="state">` · `.orient an-block` (30-sec read + falsifiers) · **`.ov-only`** (the whole Layman page) · **`.an-only`** (the analyst spine §1–§10, cohorts, §9 catalysts, §10 evidence) · related-desks · brief funnel · footer.
